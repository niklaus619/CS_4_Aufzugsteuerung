...
export class LasalRuntimeSigControlSwitchButton2 extends LasalRuntimeSigElement {
    ...
    ****************************************************************************************************/
    ...
    initialized: boolean
    ignoreoffvalue: boolean
    ignoreonvalue: boolean
    textOnSpan: HTMLElement | null
    textOffSpan: HTMLElement | null
    ...
    ****************************************************************************************************/
    ready(): void {
        ...
        this.thumbContainer = this.$['sig-control-switch-button2-thumb-container'] as HTMLElement;
    ...
    * @memberof LasalRuntimeSigControlSwitchButton2
    ****************************************************************************************************/
    _thumbAnimationEndHandler(): void {
        if (this.initialized) {
            this._setThumbPos();
    ...
    _stateChanged(newstate: number, oldstate: number): void {
        if ((this.initialized) && (!this.isdesignmode)) {
            if (newstate !== null && newstate !== undefined) {
                const newVal = parseFloat(newstate as any);
    ...
    * @memberof LasalRuntimeSigControlSwitchButton2
    ****************************************************************************************************/
    _previewChanged(newVal: boolean): void {
        if (!this.isdesignmode) {
            return;
        }
    ...
    * @memberof LasalRuntimeSigControlSwitchButton2
    ****************************************************************************************************/
    _activeImgChange(newVal: string): void {
        if (newVal === '') {
    ...
    * @memberof LasalRuntimeSigControlSwitchButton2
    ****************************************************************************************************/
    _inactiveImgChange(newVal: string): void {
        if (newVal === '') {
    ...
    * @memberof LasalRuntimeSigControlSwitchButton2
    ****************************************************************************************************/
    sigOnVisibilityChange(isVisible: boolean): void {
        //call base
