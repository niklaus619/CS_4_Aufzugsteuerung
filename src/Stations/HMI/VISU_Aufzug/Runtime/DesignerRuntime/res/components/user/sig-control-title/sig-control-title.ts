...
export class LasalRuntimeSigTitleElement extends LasalRuntimeSigElement {
    ...
    neon1blur: string
    neon2blur: string
    neon1strength: string
    neon2strength: string
    ...
    appRouter: SigApi.ApiAppRouter
    textManager: SigApi.ApiTextManager
    isReady: boolean
    propsReady: boolean
    activeRoute: SigApi.Route | null
    ...
    ready(): void {
        ...
        SigPolymer.afterNextRender(this, function (this: LasalRuntimeSigTitleElement) {
    ...
    ****************************************************************************************************/
     ...
     * @memberof LasalRuntimeSigTitleElement
     ********************************************************************************************************************************/
    _updateTextShadow(newval?: string, oldval?: string): void {
        if (this.propsReady && this.isReady) {
            let textShadow = this._getTextShadow();
            (this.$.label as HTMLElement).style.textShadow = textShadow;
        } 
    }
     ...
     * @memberof LasalRuntimeSigTitleElement
     ********************************************************************************************************************************/
    _labelCHG(name?:string, value?: any): void {
