 ...
 #define _CStrLibInternH
  ...
  #define _ISXDIGIT(A) (sigclib_TypeOfC[(unsigned char)(A)] & c_XDIGIT)
  #define _ISSPACE(A)  (sigclib_TypeOfC[(unsigned char)(A)] & c_SPACE)
  #define _ISALPHA(A)  (sigclib_TypeOfC[(unsigned char)(A)] & c_ALPHA)
  #define _ISPUNCT(A)  (sigclib_TypeOfC[(unsigned char)(A)] & c_PUNCT)
  #define _ISALNUM(A)  (sigclib_TypeOfC[(unsigned char)(A)] & c_ALNUM)
  #define _ISPRINT(A)  (sigclib_TypeOfC[(unsigned char)(A)] & c_PRINT)
