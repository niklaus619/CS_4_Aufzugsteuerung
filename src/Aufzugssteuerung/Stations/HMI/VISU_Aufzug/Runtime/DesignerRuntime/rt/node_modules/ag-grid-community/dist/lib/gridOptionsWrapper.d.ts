...
import { ChartRef, FillOperationParams, GetChartToolbarItems, GetContextMenuItems, GetMainMenuItems, GetRowNodeIdFunc, GetServerSideStoreParamsParams, GridOptions, IsApplyServerSideTransaction, IsGroupOpenByDefaultParams, IsRowMaster, IsRowSelectable, IsServerSideGroupOpenByDefaultParams, NavigateToNextCellParams, NavigateToNextHeaderParams, PaginationNumberFormatterParams, PostProcessPopupParams, ProcessDataFromClipboardParams, ServerSideStoreParams, TabToNextCellParams, TabToNextHeaderParams } from 'ag-grid-community/dist/lib/entities/gridOptions';
import { GridApi } from 'ag-grid-community/dist/lib/gridApi';
import { ColDef, ColGroupDef, IAggFunc, SuppressKeyboardEventParams } from 'ag-grid-community/dist/lib/entities/colDef';
...
import { CsvExportParams, ProcessCellForExportParams, ProcessHeaderForExportParams } from 'ag-grid-community/dist/lib/interfaces/exportParams';
...
export declare class GridOptionsWrapper {
    ...
    getRowStyle(): import("ag-grid-community/dist/lib/entities/gridOptions").RowStyle | undefined;
    getRowClass(): string | string[] | undefined;
    getRowStyleFunc(): ((params: import("ag-grid-community/dist/lib/entities/gridOptions").RowClassParams) => import("ag-grid-community/dist/lib/entities/gridOptions").RowStyle) | undefined;
    getRowClassFunc(): ((params: import("ag-grid-community/dist/lib/entities/gridOptions").RowClassParams) => string | string[] | undefined) | undefined;
    rowClassRules(): import("ag-grid-community/dist/lib/entities/gridOptions").RowClassRules | undefined;
    ...
    getSendToClipboardFunc(): ((params: import("ag-grid-community/dist/lib/entities/gridOptions").SendToClipboardParams) => void) | undefined;
