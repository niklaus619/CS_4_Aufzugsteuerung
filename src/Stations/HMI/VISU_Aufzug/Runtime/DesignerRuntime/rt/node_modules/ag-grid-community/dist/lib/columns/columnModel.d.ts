...
import { IHeaderColumn } from 'ag-grid-community/dist/lib/entities/iHeaderColumn';
import { IProvidedColumn } from 'ag-grid-community/dist/lib/entities/iProvidedColumn';
...
export declare class ColumnModel extends BeanStub {
    ...
    getDisplayNameForOriginalColumnGroup(columnGroup: ColumnGroup | null, originalColumnGroup: ProvidedColumnGroup | null, location: string): string | null;
    ...
    getOriginalColumnGroup(key: ProvidedColumnGroup | string): ProvidedColumnGroup | null;
