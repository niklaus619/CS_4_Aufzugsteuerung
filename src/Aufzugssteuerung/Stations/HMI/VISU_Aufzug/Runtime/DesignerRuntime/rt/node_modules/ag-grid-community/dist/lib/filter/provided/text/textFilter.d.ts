import { SimpleFilter, ConditionPosition, ISimpleFilterParams, ISimpleFilterModel, ISimpleFilterModelType, Tuple } from 'ag-grid-community/dist/lib/filter/provided/simpleFilter';
