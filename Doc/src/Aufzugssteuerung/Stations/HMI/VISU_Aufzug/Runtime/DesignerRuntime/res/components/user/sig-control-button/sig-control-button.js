...
export class LasalRuntimeSigButtonElement extends LasalRuntimeSigElement {
    ...
    ****************************************************************************************************/
    constructor() {
        ...
        if (this.sigSetForceUpdateForProperty)
            this.sigSetForceUpdateForProperty('value');
        this.addPredefProps([{
                src: 'value',
                dest: 'state',
    ...
    ****************************************************************************************************/
    ready() {
        ...
        this.textForeground = this.$['sig-control-button-foreground'];
        this.textBackground = this.$['sig-control-button-background'];
    ...
    _handleDown(event) {
        if (!this.isdesignmode) {
            if (this.sigbtntype === 'click') {
                ...
                if ((parseFloat(this.value) !== this.valueset) && (this.ignorevalueset === false)) {
                    this.value = this.valueset;
                }
...
//# sourceMappingURL=sig-control-button.js.map