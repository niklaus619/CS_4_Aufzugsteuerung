...
/**
 * Demo how to use sigApi.vm.newViewModel to append a control to a window
 * 
 * demo setup:
...
class WindowModuleNewViewModel implements SigApi.ViewModelCodeModule {
    readonly DP_PREFIX = '0:Data00.Server';
    readonly MAX_CONTROLS = 10;
    /**
     * @returns {WindowModuleNewViewModel}
     */
    static create(): WindowModuleNewViewModel {
        return new WindowModuleNewViewModel();
    }
...
// Register the WindowModuleNewViewModel for a window
window.registerWindowModule('Window0', WindowModuleNewViewModel.create);
