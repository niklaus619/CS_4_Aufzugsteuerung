 ...
 #define _CSysLibH
  ...
  #include "DefineCompiler.h"
    ...
    // check if opsys is gecko
    cExtern unsigned long sigclib_is_gecko(void);

    // check if opsys is lars
    cExtern unsigned long sigclib_is_lars(void);

    // check if opsys is linux
    cExtern unsigned long sigclib_is_linux(void);
    ...
    // get "Sigmatek flag" from named class
    cExtern unsigned long sigclib_sigmatek_class(const char *classname);

    // get "Sigmatek flag" from given object
    cExtern unsigned long sigclib_sigmatek_obj(void *pthis);
    ...
    cExtern unsigned long sigclib_thread_create2(void* pfkt, unsigned long priority, unsigned long time_us, void *pcookie, const char *name, unsigned long flags=0);
    ...
    cExtern long sigclib_setenvvar(const char *name, const char *value);
    
    // get environmentvariable
    cExtern long sigclib_getenvvar(const char *name, char *value, unsigned long sizeof_value);
    
    // get serialnumber of volume
    cExtern _uint32 sigclib_get_serialnumber_volume(char *dst, _uint32 sizeof_dst, _uint32 drive);

    // get serialnumber of plc
    cExtern _uint32 sigclib_get_serialnumber_plc(char *dst, _uint32 sizeof_dst);
    ...
    // check if opsys is gecko
    function global __cdecl sigclib_is_gecko var_output retcode:udint; end_var;

    // check if opsys is lars
    function global __cdecl sigclib_is_lars var_output retcode:udint; end_var;

    // check if opsys is linux
    function global __cdecl sigclib_is_linux var_output retcode:udint; end_var;
    ...
    // get "Sigmatek flag" from given object
    function global __cdecl sigclib_sigmatek_obj var_input pthis:^void; end_var var_output retcode:udint; end_var;

    // get "Sigmatek flag" from named class
    function global __cdecl sigclib_sigmatek_class var_input classname:^char; end_var var_output retcode:udint; end_var;
    ...
    function global __cdecl sigclib_thread_create2 var_input pfkt:^void; priority:udint; time_us:udint; pcookie:^void; name:^char; flags:udint:=0; end_var var_output retcode:udint; end_var;
    ...
    // set environmentvariable
    function global __cdecl sigclib_setenvvar var_input name:^char; value:^char; end_var var_output retcode:dint; end_var;
    
    // get environmentvariable
    function global __cdecl sigclib_getenvvar var_input name:^char; value:^char; sizeof_value:udint; end_var var_output retcode:dint; end_var;
    
    // get serialnumber of volume
    function global __cdecl sigclib_get_serialnumber_volume var_input dst:^char; sizeof_dst:udint; drive:udint; end_var var_output retcode:udint; end_var;

    // get serialnumber of plc
    function global __cdecl sigclib_get_serialnumber_plc var_input dst:^char; sizeof_dst:udint; end_var var_output retcode:udint; end_var;
...
// check if opsys is salamander
// function will return <>0 when salamander-opsys is in use, on the other hand 0

// ------------------------------------------------------------------------------------------------
// unsigned long sigclib_is_gecko(void);
// check if opsys is gecko
// function will return <>0 when gecko-opsys is in use, on the other hand 0

// ------------------------------------------------------------------------------------------------
// unsigned long sigclib_is_lars(void);
// check if opsys is lars
// function will return <>0 when lars-opsys is in use, on the other hand 0
   
// ------------------------------------------------------------------------------------------------
// unsigned long sigclib_is_linux(void);
// check if opsys is based on linux
// function will return <>0 when linux-opsys is in use, on the other hand 0
...
// ------------------------------------------------------------------------------------------------
// unsigned long sigclib_sigmatek_class(const char *classname);
// function is used to get "Sigmatek flag" from named class
// --> classname ....... name of Lasal-Class
// <-- function will return 1 if "Sigmatek Flag" is set at class, on the other hand 0

// ------------------------------------------------------------------------------------------------
// unsigned long sigclib_sigmatek_obj(void *pthis);
// function is used to get "Sigmatek flag" from given object
// --> classname ....... name of Lasal-Class
// <-- function will return 1 if "Sigmatek Flag" is set at class of object, on the other hand 0
...
// create new thread  
// --> pfkt ............ address of method or function eg.: function global __cdecl MyClass::Thread var_input pthis:^void; end_var;
...
// --> pfkt ............ address of global function to handle, eg.: function global __cdecl MyClass::Thread var_input pcookie:^void; end_var var_output run:udint; end_var;
// --> priority ........ prio 10=bk , prio 14=Cy, prio 16=rt
// --> time_us ......... delaytime in us (see NOTE below)
// --> pcookie ......... cookie
// --> name ............ name of thread
// --> flags ........... usually 0 (most significant 4 bits are used to assign core-number. 0=core0, 0x10000000=core1, ...)
// <-- valid thread-handle, or 0 on error
...
// set environmentvariable
// --> name ............ name of environmentvariable to set
// --> value ........... value (ascii-0-string) to set
// <-- function wiil return a value >0 on success
    
// ------------------------------------------------------------------------------------------------
// long sigclib_getenvvar(const char *name, char *value, unsigned long sizeof_value);
// get environmentvariable
// --> name ............ name of environmentvariable to get
// --> value ........... pointer to destination where to file value (ascii-array)
// --> sizeof_value .... bytesize of destination array
// <-- Function wiil return a value >0 on success

// ------------------------------------------------------------------------------------------------
// _uint32 sigclib_get_serialnumber_volume(char *dst, _uint32 sizeof_dst, _uint32 drive_letter)
// Function is used to get SerialNumbeer of given drive
// --> dst ............. destination where serialnumber should be filed, size should be at least 32bytes
// --> sizeof_dst ...... size of destination in bytes
// --> drive_letter .... Driveletter to get SerialNumber (eg.: 'f')
// <-- Function will return size of serialnumber in bytes or 0 on error

// ------------------------------------------------------------------------------------------------
// _uint32 sigclib_get_serialnumber_plc(char *dst, _uint32 sizeof_dst)
// Function will get SerialNumber from plc
// --> dst ............. destination where serialnumber should be filed, size should be at least 32bytes
// --> sizeof_dst ...... size of destination in bytes
// <-- Function will return size of serialnumber in bytes or 0 on error
