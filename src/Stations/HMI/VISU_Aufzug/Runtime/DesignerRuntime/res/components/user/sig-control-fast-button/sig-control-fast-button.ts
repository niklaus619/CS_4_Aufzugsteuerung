...
export class LasalRuntimeSigFastButtonElement extends LasalRuntimeSigElement {
    ...
    ****************************************************************************************************/
    ...
    btntextc: string
    btnimage: string
    btnimagepressedc: string
    btntextpressedc: string
    btnstate: number
    shadowactive: boolean
    shadowpressedactive: boolean
    bordergradient: boolean
    bordergradientpressed: boolean
    previewpressedstate: boolean
    ...
    ****************************************************************************************************/
    ...
    timeout: null | number
    btnimagepressed: string
    btntextpressed: string
    previewtext: string
    startdelay: number
    intervaltime: number
    btnid: number
    ...
    evtMedApi: SigApi.ApiEventMediator
    constApi: SigApi.ApiSigConst
    clientApi: SigApi.ApiClientIdentification
    accessApi: SigApi.ApiAccessSequence
    wsApi: SigApi.ApiWebsocketState
    textForeground: HTMLElement | null
    textBackground: HTMLElement | null

    evtIds: {
        major: number,
        getClassClient: number,
        setClassClient: number,
        buttonStart: number
    }
    evtVersions: {
        getClassClient: number,
    ...
    ****************************************************************************************************/
    ...
    _registerEventListeners(): void {
        ...
        this.evtSubscriptions.setClassClient = this.evtMedApi.subscribeWithId(this.evtIds.major, this.evtIds.setClassClient, 
        (maId: number, miID: number, msg: any) => {
     ...
     * @memberof LasalRuntimeSigFastButtonElement
     ****************************************************************************************************/
    _handleSetClassClient(dv: DataView): void {
     ...
     * @memberof LasalRuntimeSigFastButtonElement
     ****************************************************************************************************/
    async _sendButtonStart(): Promise<void> {
        // get position
     ...
     * @memberof LasalRuntimeSigFastButtonElement
     ****************************************************************************************************/
    _evalDataType(onValue: number, offValue: number): number {
    ...
    _getDatapoint(): number | null {
        if (this.propApi !== null) {
            ...
            if (prop !== null) {
                ...
                if ((prop as SigApi.PropertyDatapoint).getDatapoint === undefined) return null;
                //get datapoint
                const dp = (prop as SigApi.PropertyDatapoint).getDatapoint();
                if (dp !== null) {
                    return dp.getId();
                }
            }    
    ...
    ****************************************************************************************************/
    _stopAutorepeat(): void {
        this._clearInterval();
        //set to off value
        if (this.dpId !== null) this.dpApi.writeDataPoint(this.dpId, this.offvalueuc);   
    }
    ...
    * @memberof LasalRuntimeSigFastButtonElement
    ****************************************************************************************************/
    _computePressedImage(normal: string = '', pressed: string = ''): string {
