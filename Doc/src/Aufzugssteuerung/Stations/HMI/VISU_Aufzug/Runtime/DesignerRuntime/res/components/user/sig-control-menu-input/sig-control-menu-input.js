...
export class LasalRuntimeSigControlMenuInput extends LasalRuntimeSigElement {
    ...
    ****************************************************************************************************/
     ...
     * @memberof LasalRuntimeSigControlMenuInput
     ********************************************************************************************************************************/
    _designerOnCaretImageChanged() {
        if (this.caretimage === 'default')
            this.caretimage = `${this.importPath}caret_down.svg`;
        if (this.caretimageactive === 'default')
            this.caretimageactive = `${this.importPath}caret_up.svg`;
    }
    /****************************************************************************************************
    ...
    ****************************************************************************************************/
     ...
     * @memberof LasalRuntimeSigControlMenuInput
    ****************************************************************************************************/
    _toggleDefaultIcon(newVal, oldVal) {
        if (this.showicon) {
    ...
    _setIcon(iconUrl = '') {
        ...
        if (!this.isdesignmode) {
            ...
            if (iconUrl && iconUrl !== '' && this.showicon) {
                ...
                this.$.activeicon.style.display = 'inline-block';
                // show default icon
            }
            else {
    ...
    ****************************************************************************************************/
    _toggleMenu() {
        if (!this.isdesignmode) {
            ...
            // open menue
            //-------------------------------------------------------------------------------------------
            if (!this.menuvisible && menuVisible && !menuVisible.isVisible) {
                ...
                showFct(this.menuref, this, property, position.left, position.top + position.height, scaleFactors.x, scaleFactors.y, this.realrotation, minimalWidth, undefined, undefined, undefined, this.direction).then((opened) => {
                    if (opened)
                        this.menuvisible = true;
                }).catch((error) => {
                    if (error.errortxt)
                        this._log('_toggleMenu(): ' + error.errortxt, 'ERROR');
                    else
                        this._log('_toggleMenu(): ' + error, 'ERROR');
                });
                // close menue
                //-------------------------------------------------------------------------------------------
            }
    ...
    ****************************************************************************************************/
    ...
    _setMenuItem(menuItem) {
        ...
        if (this.currentMenuItemObs)
            this.currentMenuItem?.removeObserver(this.currentMenuItemObs);
        ...
        if (menuItem) {
            ...
            menuItem.getPropertyValue('text').then((value) => {
                ...
                this.currentMenuItemObs = this.currentMenuItem?.addObserver('text', (text) => {
    ...
    ****************************************************************************************************/
     ...
     * @memberof LasalRuntimeSigControlMenuInput
    ****************************************************************************************************/
    _updateTextFromDatapoint(value) {
        if (!this.isdesignmode) {
    ...
    ****************************************************************************************************/
     ...
     * @memberof LasalRuntimeSigControlMenuInput
    ****************************************************************************************************/
    _defaultTextChanged(newVal, oldVal) {
...
//# sourceMappingURL=sig-control-menu-input.js.map