...
export declare const _: {
    ...
    sortRowNodesByOrder(rowNodes: import("ag-grid-community/dist/lib/main").RowNode[], rowNodeOrder: {
        [id: string]: number;
    }): void;
    traverseNodesWithKey(nodes: import("ag-grid-community/dist/lib/main").RowNode[] | null, callback: (node: import("ag-grid-community/dist/lib/main").RowNode, key: string) => void): void;
    ...
    isUserSuppressingKeyboardEvent(gridOptionsWrapper: import("ag-grid-community/dist/lib/gridOptionsWrapper").GridOptionsWrapper, keyboardEvent: KeyboardEvent, rowNode: import("ag-grid-community/dist/lib/main").RowNode, column: import("ag-grid-community/dist/lib/main").Column, editing: boolean): boolean;
    isUserSuppressingHeaderKeyboardEvent(gridOptionsWrapper: import("ag-grid-community/dist/lib/gridOptionsWrapper").GridOptionsWrapper, keyboardEvent: KeyboardEvent, headerRowIndex: number, column: import("ag-grid-community/dist/lib/main").Column | import("ag-grid-community/dist/lib/main").ColumnGroup): boolean;
    createIcon(iconName: string, gridOptionsWrapper: import("ag-grid-community/dist/lib/gridOptionsWrapper").GridOptionsWrapper, column: import("ag-grid-community/dist/lib/main").Column | null): HTMLElement;
    createIconNoSpan(iconName: string, gridOptionsWrapper: import("ag-grid-community/dist/lib/gridOptionsWrapper").GridOptionsWrapper, column?: import("ag-grid-community/dist/lib/main").Column | null | undefined, forceCreate?: boolean | undefined): HTMLElement | undefined;
    iconNameClassMap: {
        [key: string]: string;
    };
    ...
    getCtrlForEvent<T_21>(gridOptionsWrapper: import("ag-grid-community/dist/lib/gridOptionsWrapper").GridOptionsWrapper, event: Event, type: string): T_21 | null;
    ...
    getAriaSortState(column: import("ag-grid-community/dist/lib/main").Column): AriaUtils.ColumnSortState;
    ...
    bindCellRendererToHtmlElement(cellRendererPromise: import("ag-grid-community/dist/lib/utils/promise").AgPromise<import("ag-grid-community/dist/lib/main").ICellRendererComp>, eTarget: HTMLElement): void;
};
