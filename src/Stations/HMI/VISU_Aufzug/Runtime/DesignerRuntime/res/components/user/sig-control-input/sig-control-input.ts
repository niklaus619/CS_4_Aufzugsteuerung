...
export class LasalRuntimeSigInputElement extends UnitConversionMixin(LasalRuntimeSigElement) {
    ...
    ****************************************************************************************************/
    ...
    bordergradientactiv: boolean
    shadowactive: boolean
    shadowactivactive: boolean
    unittext: string
    unitactiv: boolean
    unitposition: string
    type: string
    ...
    ****************************************************************************************************/
    static get properties(): object {
     ...
     dashboardKeyboard: HTMLElement | null
     app: any
     maxlength: number
     constApi: SigApi.ApiSigConst 
     vmApi: SigApi.ApiViewModel
     //keyboardApi = typeof window.sigApi.keyboard // defined in unitConversionMixin
     eventMediatorApi: SigApi.ApiEventMediator
     eventsApi: SigApi.ApiEvents
     keyboardid: string
     titletext: string
     writeonincrement: boolean
     previewtext: string
     openkeyboardbeside: boolean
     keyboardwindow: string | number | null | undefined
     format: string
    ...
    * @memberof LasalRuntimeSigInputElement
    ****************************************************************************************************/
    async _switchLang(): Promise<void> {
    ...
    * @memberof LasalRuntimeSigInputElement
    ****************************************************************************************************/
    _updateValue(newValue: string|number): void {
        this.value = newValue;
    ...
    * @memberof LasalRuntimeSigInputElement
    ****************************************************************************************************/
    _makePassword(newval: boolean, oldval: boolean): void {
        ...
        if (newval !== undefined) {
            ...
            (this.$.siginput as HTMLElement).setAttribute('type', type);
        } else{
            (this.$.siginput as HTMLElement).setAttribute('type', '');
        }
    ...
    * @memberof LasalRuntimeSigInputElement
    ****************************************************************************************************/
    _stateChanged(newstate: string, oldstate: string | undefined): void {
    ...
    _showKeyboard(): void {
        if (!this.isdesignmode) {
            ...
            if (this.keyboardid && this.keyboardid !== '' && this.context && !this.isdesignmode) {
                ...
                const isKeyboardHidden = (keyboard) ? (keyboard as any).state === stateInvisibile || (keyboard as any).state === stateIntacive : false;
            ...
            if (this.keyboardApi) {
                if(this.keyboardwindow === null) this.keyboardwindow = undefined;
    ...
    * @memberof LasalRuntimeSigInputElement
    ****************************************************************************************************/
    _computeText(_value: string, _previewtext: string, _isstylepreview: boolean, value_converted: string, _format): string {
